...
<header>
    ...
    <script>
        ...
        <script>
         ...
         <input type="date" id="data_nascimento" name="data_nascimento" min="2011-01-01" max="<?php echo date('Y-m-d'); ?>" required><br>
        ...
        <span id="cepError" style="color: red; display: none;">O CEP deve ter o formato XXXXX-XXX.</span><br>
        ...
        document.getElementById("cep").addEventListener('input', function(e) {
            ...
            <span id="telefoneError" style="color: red; display: none;">O telefone deve ter o formato (XX) XXXXX-XXXX ou (XX) XXXX-XXXX.</span><br>
